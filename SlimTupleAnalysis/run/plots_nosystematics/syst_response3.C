...
#include "rebin.h"
  ...
  Int_t color_index[nsyst] ={600,632,416,920};
  //Int_t color_index[nsyst] ={600,632,416,920,616,432,800,840};
  //enum EColor { kWhite =0,   kBlack =1,   kGray=920,
  //kRed   =632, kGreen =416, kBlue=600, kYellow=400, kMagenta=616, kCyan=432,
  //kOrange=800, kSpring=820, kTeal=840, kAzure =860, kViolet =880, kPink=900 };

  TString systname[nsyst]={"NP_Special6JESUp","PunchThroughJESUp","ClosebyJESUp","NonClosure_AFIIJESUp"};
  ...
  TFile *fnom=TFile::Open("~azaman/Analysis5/SlimTupleAnalysis/run/hwwlvqq.Nominal.sigtest.caf4.2.lv4_smw.root");
  ...
  for (int isyst=0;isyst<nsyst;isyst++){
    ...
    fsyst[isyst]=TFile::Open(Form("~azaman/Analysis5/SlimTupleAnalysis/run/hwwlvqq.%s.sigtest.caf4.2.lv4_smw.root",systname[isyst].Data()));
  }
