{
  ...
  bool pdfforNote = 1;
  if (!pdfforNote) c2->Print("plots_stack_noQCD.pdf[","pdf"); //&&&&

  
  //TFile *f=TFile::Open("~azaman/Analysis5/SlimTupleAnalysis/run/hwwlvqq_fat12_veto.root");
  //TFile *f=TFile::Open("~azaman/Analysis5/SlimTupleAnalysis/run/hwwlvqq_loose_noveto.root");
  //TFile *f=TFile::Open("~azaman/Analysis5/SlimTupleAnalysis/run/hwwlvqq_fat12_noveto.root");  //xxxxxx
  
  
  //TFile *f=TFile::Open("~azaman/Analysis5/SlimTupleAnalysis/run/hwwlvqq.Nominal.caf4.2.lv4_fatwindow40_140_mjjTag0_fatjetmass.root"); //&&&& fat jet mass modeling
  
  //TFile *f=TFile::Open("~azaman/Analysis5/SlimTupleAnalysis/run/fakeEstimation/lvqqNoMetFakeRegion.caf4.1.lv7.1_looseBadLep4.root"); //MET plot for v3 note
  //TFile *f=TFile::Open("~azaman/Analysis5/SlimTupleAnalysis/run/fakeEstimation/lvqqWithMetFakeRegion.caf4.1.lv7_looseBadLep4.root"); //mTWV plot for v3 note
  //TFile *f=TFile::Open("~azaman/Analysis5/SlimTupleAnalysis/run/fakeEstimation/lvqqWithMetFakeRegion.caf4.1.lv7_looseBadMuon1.1.root");//mTWV plot for v3 note (bad lepton without isolation)
  
  
  //TFile *f=TFile::Open("~azaman/Analysis5/SlimTupleAnalysis/run/fakeEstimation/lvqqNoMetFakeRegion.caf4.2.lv8.1_smw_wp10.root"); //MET plot in v4
  TFile *f=TFile::Open("~azaman/Analysis5/SlimTupleAnalysis/run/fakeEstimation/lvqqNoMetFakeRegion.caf4.2.lv8.1_smw_wp20.root"); //This should be MET plot for v4 note
  //TFile *f=TFile::Open("~azaman/Analysis5/SlimTupleAnalysis/run/fakeEstimation/lvqqWithMetFakeRegion.caf4.2.lv8_smw_wp20.root"); //mTWV plot for v4 note
  //TFile *f=TFile::Open("~azaman/Analysis5/SlimTupleAnalysis/run/fakeEstimation/lvqqWithMetFakeRegion.caf4.1_looseBadMuon1.1.lv8_smw_wp20.root"); //mTWV plot for v4 note (bad lepton without isolation)

  //TFile *f=TFile::Open("~azaman/Analysis5/SlimTupleAnalysis/run/hwwlvqq.Nominal.caf4.2.lv7.1_looseBadLep4.root");
  //TFile *f=TFile::Open("~azaman/Analysis5/SlimTupleAnalysis/run/hwwlvqq.Nominal.caf4.2.lv8_smw_noSeparateWjetsEWK.root");
  //TFile *f=TFile::Open("~azaman/Analysis5/SlimTupleAnalysis/run/hwwlvqq.Nominal.caf4.2.lv7_looseBadLep4.root");

  //TFile *f=TFile::Open("~azaman/Analysis5/SlimTupleAnalysis/run/fakeEstimation/lvqqNoMetFakeRegion.caf4.2.lv8.1.f100.root");
  //TFile *f=TFile::Open("~azaman/Analysis5/SlimTupleAnalysis/run/fakeEstimation/lvqqNoMetFakeRegion.caf4.2.lv8.1_smw_noSeparateWjetsEWK.root");
  //TFile *f=TFile::Open("~azaman/Analysis5/SlimTupleAnalysis/run/fakeEstimation/lvqqWithMetFakeRegion.caf4.2.lv8.1_smw_noSeparateWjetsEWK.root");
  //TFile *f=TFile::Open("~azaman/Analysis5/SlimTupleAnalysis/run/fakeEstimation/lvqqWithMetFakeRegion.caf4.2.lv8_smw_noSeparateWjetsEWK.root");
  //TFile *f=TFile::Open("~azaman/Analysis5/SlimTupleAnalysis/run/fakeEstimation/lvqqNoMetFakeRegion.caf4.2.lv8_smw_nocutAwv.root");
  //TFile *f=TFile::Open("~azaman/Analysis5/SlimTupleAnalysis/run/fakeEstimation/lvqqNoMetFakeRegion.caf4.2.lv8_smw_nocutMjjTag.root");
  ...
  //const int nType=1;TString typeName[nType]={"fatjetM_pt200"};
  //const int nType=1;TString typeName[nType]={"fatjet_M"};
  //const int nType=1;TString typeName[nType]={"Mwjj"};  //&&&& fat jet mass modeling
  const int nType=1;TString typeName[nType]={"MET_et"};
  //const int nType=3;TString typeName[nType]={"MET_et","ptwlep","mTWV"};
  //const int nType=5;TString typeName[nType]={"MET_et","ptwlep","mTWV","mjjTagged","VVptBalance"};
  ...
  for (int icut=0;icut<nCut;++icut){
	...
	if (drawTwoPads){
	  ...
	  //float xstart=h_data->GetBinLowEdge(1);
	  //float xend=h_data->GetBinLowEdge(h_data->GetNbinsX()+1);
