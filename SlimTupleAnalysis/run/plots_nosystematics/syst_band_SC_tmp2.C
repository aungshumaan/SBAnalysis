...
void syst_band_SC_tmp2(){ 
  ...
  //TFile *f2=TFile::Open("~azaman/Analysis5/SlimTupleAnalysis/run/hwwlvqq.Nominal.caf4.2.lv4_smw_separateWjetsEWK.root");
  TFile *f2=TFile::Open("~azaman/Analysis5/SlimTupleAnalysis/run/hwwlvqq.Nominal.caf4.2.lv4_smw_separateWjetsEWK_mTWV150bin.root");
  ...
  const int nType=4;TString typeName[nType]={"Mwjj","MET_et","mTWV","mT"};
  ...
  for (int icut=0;icut<nCut;++icut){
	...
	h_Wjets=(TH1F*)f2->Get(Form("H_Wjets_ep_WBF_%s_%s", cutName[icut].Data(),typeName[itype].Data())); //&&&& f2
	h_Wjets->Add((TH1F*)f2->Get(Form("H_Wjets_em_WBF_%s_%s", cutName[icut].Data(),typeName[itype].Data()))); //&&&& f2
	h_Wjets->Add((TH1F*)f2->Get(Form("H_Wjets_mp_WBF_%s_%s", cutName[icut].Data(),typeName[itype].Data())));
	h_Wjets->Add((TH1F*)f2->Get(Form("H_Wjets_mm_WBF_%s_%s", cutName[icut].Data(),typeName[itype].Data())));

	// h_Wjets=(TH1F*)f->Get(Form("H_Wjets_ep_WBF_%s_%s", cutName[icut].Data(),typeName[itype].Data())); //&&&& f2
	// h_Wjets->Add((TH1F*)f->Get(Form("H_Wjets_em_WBF_%s_%s", cutName[icut].Data(),typeName[itype].Data()))); //&&&& f2
	...
	h_WjetsEWK=(TH1F*)f2->Get(Form("H_WjetsEWKSherpa_ep_WBF_%s_%s", cutName[icut].Data(),typeName[itype].Data())); //&&&& f2
	h_WjetsEWK->Add((TH1F*)f2->Get(Form("H_WjetsEWKSherpa_em_WBF_%s_%s", cutName[icut].Data(),typeName[itype].Data()))); //&&&& f2
	h_WjetsEWK->Add((TH1F*)f2->Get(Form("H_WjetsEWKSherpa_mp_WBF_%s_%s", cutName[icut].Data(),typeName[itype].Data())));
	h_WjetsEWK->Add((TH1F*)f2->Get(Form("H_WjetsEWKSherpa_mm_WBF_%s_%s", cutName[icut].Data(),typeName[itype].Data())));
	...
	//c2->Print("plots_syst_band.pdf",Form("Title:%s_%s",cutName[icut].Data(), typeName[itype].Data()));
	//c2->Print(Form("PDF_syst_band/noScaleWjets_%s_%s.pdf",cutName[icut].Data(),typeName[itype].Data()) );
