...
#include "makerHelper.h"
  ...
  bool pdfforNote = 1;
  if (!pdfforNote)c1->Print("plots_sherpaAlp.pdf[","pdf");
  ...
  //TFile *f2=TFile::Open("../hwwlvqq.185726.FatJESUp.root");
  //TFile *f3=TFile::Open("../hwwlvqq.185726.JMSUp.root");
  ...
  */
  ...
  //TFile *f2=TFile::Open("../hwwlvqq.FatJESUp.ttbar.lv4_fmw40_140_mjjT0.root");
  //TFile *f3=TFile::Open("../hwwlvqq.FatJESDown.ttbar.lv4_fmw40_140_mjjT0.root");
  ...
  //TFile *f2=TFile::Open("../hwwlvqq.FatJPTRUp.ttbar.lv4_fmw40_140_mjjT0.root");
  //TFile *f3=TFile::Open("../hwwlvqq.FatJPTRDown.ttbar.lv4_fmw40_140_mjjT0.root");
  TFile *f2=TFile::Open("../hwwlvqq.FatJMRUp.ttbar.lv4_fmw40_140_mjjT0.root");
  TFile *f3=TFile::Open("../hwwlvqq.FatJMRDown.ttbar.lv4_fmw40_140_mjjT0.root");
  ...
  //TFile *f2=TFile::Open("~azaman/Analysis5/SlimTupleAnalysis/run/HWWLVQQ.caf4.2.lv4_fatwindow40_140_mjjTag0_fatjetmass/hwwlvqq.FatJPTRUp.root");
  // TFile *f3=TFile::Open("~azaman/Analysis5/SlimTupleAnalysis/run/HWWLVQQ.caf4.2.lv4_fatwindow40_140_mjjTag0_fatjetmass/hwwlvqq.FatJMRUp.root");
  ...
  //const int nSample =4; TString sampleName[nSample] = {"Wjets","Zjets","SingleTop","WZZZWg"};
  //const int nSample =6; TString sampleName[nSample] = {"Wjets","Zjets","SingleTop","WZZZWg","VBS_WV_0_0","VBS_WV_01_0"};
  //const int nSample =3; TString sampleName[nSample] = {"VBS_WV_0_0","WW","WZ"};
  //const int nSample =2; TString sampleName[nSample] = {"VBS_WV_0_0","VBS_WV_01_0"};
  ...
  //const int nHist =2 ;TString histName[nHist]={"mjjTagged","mTWV"};
  //const int nHist =1 ;TString histName[nHist]={"fatjet_M"};
  ...
  for (int iRegion=0;iRegion<nRegion;iRegion++){	  
	...
	h1->Add( (TH1F*)f1->Get(Form("H_%s_mp_WBF_%s_%s", sampleName[iSample].Data(),  regionName[iRegion].Data(), histName[iHist].Data()) ));
	h1->Add( (TH1F*)f1->Get(Form("H_%s_mm_WBF_%s_%s", sampleName[iSample].Data(),  regionName[iRegion].Data(), histName[iHist].Data()) ));
	TH1F* h2=(TH1F*)f2->Get(Form("H_%s_ep_WBF_%s_%s", sampleName[iSample].Data(),  regionName[iRegion].Data(), histName[iHist].Data()) );
	h2->Add( (TH1F*)f2->Get(Form("H_%s_em_WBF_%s_%s", sampleName[iSample].Data(),  regionName[iRegion].Data(), histName[iHist].Data()) ));
	h2->Add( (TH1F*)f2->Get(Form("H_%s_mp_WBF_%s_%s", sampleName[iSample].Data(),  regionName[iRegion].Data(), histName[iHist].Data()) ));
	h2->Add( (TH1F*)f2->Get(Form("H_%s_mm_WBF_%s_%s", sampleName[iSample].Data(),  regionName[iRegion].Data(), histName[iHist].Data()) ));
	TH1F* h3=(TH1F*)f3->Get(Form("H_%s_ep_WBF_%s_%s", sampleName[iSample].Data(),  regionName[iRegion].Data(), histName[iHist].Data()) );
	h3->Add( (TH1F*)f3->Get(Form("H_%s_em_WBF_%s_%s", sampleName[iSample].Data(),  regionName[iRegion].Data(), histName[iHist].Data()) ));
	h3->Add( (TH1F*)f3->Get(Form("H_%s_mp_WBF_%s_%s", sampleName[iSample].Data(),  regionName[iRegion].Data(), histName[iHist].Data()) ));
	h3->Add( (TH1F*)f3->Get(Form("H_%s_mm_WBF_%s_%s", sampleName[iSample].Data(),  regionName[iRegion].Data(), histName[iHist].Data()) ));
	...
	//TH1F* h3=(TH1F*)f1->Get(Form("H_TruthWjetsrenorm025_%s_WBF_%s_%s",  flavorName[iFlavor].Data(), regionName[iRegion].Data(), histName[iHist].Data()) );
	  ...
	  if (histName[iHist].Contains("fatjet_eta") )h1-> GetXaxis()->SetRangeUser( -1.2,1.2 );
	  if (histName[iHist].Contains("fatjet_M") )h1-> GetXaxis()->SetRangeUser( 45, 140 ); 
	  ...
	  //Haha
	  l->AddEntry(h1,"Nominal ","l");
	  //l->AddEntry(h2,"JPTS Up ","l");
	  //if (doThree ) l->AddEntry(h3,"JPTS Down","l");
	  //l->AddEntry(h2,"JMS Up ","l");
	  //if (doThree ) l->AddEntry(h3,"JMS Down","l");
	  //l->AddEntry(h2,"JPTR Up","l");
	  //if (doThree ) l->AddEntry(h3,"JPTR Down ","l");
	  l->AddEntry(h2,"JMR Up ","l");
	  if (doThree ) l->AddEntry(h3,"JMR Down","l");
	  ...
	  if (histName[iHist].Contains("fatjet_eta") )ratioHist-> GetXaxis()->SetRangeUser( -1.2, 1.2 );
	  if (histName[iHist].Contains("fatjet_M") )ratioHist-> GetXaxis()->SetRangeUser( 45,140 ); 
	  ...
	  if (histName[iHist].Contains("fatjet_pt") )horiz_line->DrawLine( 200,1.0,500,1.0 );
	  else if (histName[iHist].Contains("fatjet_eta") )horiz_line->DrawLine( -1.2,1.0,1.2,1.0 );
	  else if (histName[iHist].Contains("fatjet_M") )horiz_line->DrawLine( 45,1.0,140,1.0 ); 
	  else horiz_line->DrawLine(xstart,1.0,xend,1.0);
	  ...
	  if (!pdfforNote) {
	    ...
	    c1->Print(Form("PDF_syst_band/%s_%s_%s.pdf", sampleName[iSample].Data(), regionName[iRegion].Data(), histName[iHist].Data()));
	  }
