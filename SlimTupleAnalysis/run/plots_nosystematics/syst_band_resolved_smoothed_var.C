...
void syst_band_resolved_smoothed_var(){ 
  ...
  for (int icut=0;icut<nCut;++icut){
	...
	h_ori_data=(TH1F*)f0->Get(Form("H_Data_e%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data()));  //data is not smoothed, so use original file
	h_ori_data->Add((TH1F*)f0->Get(Form("H_Data_m%s_WBF_%s_%s", flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())));

	
	

	h_ori_Wjets=(TH1F*)f->Get(Form("H_Wjets_e%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data())); 
	h_ori_Wjets->Add((TH1F*)f->Get(Form("H_Wjets_m%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data()))); 
	...
	h_ori_WjetsEWK=(TH1F*)f->Get(Form("H_WjetsEWKSherpa_e%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data())); 
	h_ori_WjetsEWK->Add((TH1F*)f->Get(Form("H_WjetsEWKSherpa_m%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data()))); 
	
	
	
	
	h_ori_Zjets=(TH1F*)f->Get(Form("H_Zjets_e%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data()));
	h_ori_Zjets->Add((TH1F*)f->Get(Form("H_Zjets_m%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data())));
	


	h_ori_diboson=(TH1F*)f->Get(Form("H_WZZZWg_e%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data()));
	h_ori_diboson->Add((TH1F*)f->Get(Form("H_WZZZWg_m%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data())));
	


	h_ori_singleTop=(TH1F*)f->Get(Form("H_SingleTop_e%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data()));
	h_ori_singleTop->Add((TH1F*)f->Get(Form("H_SingleTop_m%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data())));
	


	h_ori_ttbar=(TH1F*)f->Get(Form("H_Ttbar_e%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data()));
	h_ori_ttbar->Add((TH1F*)f->Get(Form("H_Ttbar_m%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data())));



	h_ori_qcd=(TH1F*)f->Get(Form("H_QCD_e%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data()));
	h_ori_qcd->Add((TH1F*)f->Get(Form("H_QCD_m%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data())));


	h_ori_sigSM=(TH1F*)f->Get(Form("H_VBS_WV_0_0_e%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data()));
	h_ori_sigSM->Add((TH1F*)f->Get(Form("H_VBS_WV_0_0_m%s_WBF_%s_%s", flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())));
	h_ori_sigSM->Add((TH1F*)f->Get(Form("H_VBS_ZV_0_0_e%s_WBF_%s_%s", flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())));
	h_ori_sigSM->Add((TH1F*)f->Get(Form("H_VBS_ZV_0_0_m%s_WBF_%s_%s", flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())));
	...
	h_ori_ttbarMCatNLO=(TH1F*)f->Get(Form("H_Ttbar_e%s_WBF_%s_%s_McnloVsPowheg",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()));
	h_ori_ttbarMCatNLO->Add ( (TH1F*)f->Get(Form("H_Ttbar_m%s_WBF_%s_%s_McnloVsPowheg",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())));
	
	h_ori_ttbarPowHer=(TH1F*)f->Get(Form("H_Ttbar_e%s_WBF_%s_%s_HerwigVsPythia",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()));
	h_ori_ttbarPowHer->Add ( (TH1F*)f->Get(Form("H_Ttbar_m%s_WBF_%s_%s_HerwigVsPythia",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())));
	
	h_ori_ttbarAcerMCUp=(TH1F*)f->Get(Form("H_Ttbar_e%s_WBF_%s_%s_AcerMCUpDown",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()));
	h_ori_ttbarAcerMCUp->Add ( (TH1F*)f->Get(Form("H_Ttbar_m%s_WBF_%s_%s_AcerMCUpDown",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())));
	...
	h_ori_Wjetsfac  = (TH1F*)f->Get(Form("H_Wjets_e%s_WBF_%s_%s_fac4",  flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()) ) ;
	h_ori_Wjetsfac  ->Add((TH1F*)f->Get(Form("H_Wjets_e%s_WBF_%s_%s_fac4",  flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())) );
	
	h_ori_Wjetsrenorm  = (TH1F*)f->Get(Form("H_Wjets_e%s_WBF_%s_%s_renorm4",  flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()) ) ;
	h_ori_Wjetsrenorm  ->Add( (TH1F*)f->Get(Form("H_Wjets_e%s_WBF_%s_%s_renorm4",  flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()) ) );
	
	h_ori_Wjetsckkw  = (TH1F*)f->Get(Form("H_Wjets_e%s_WBF_%s_%s_ckkw30",  flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()) ) ;
	h_ori_Wjetsckkw  ->Add( (TH1F*)f->Get(Form("H_Wjets_e%s_WBF_%s_%s_ckkw30",  flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()) ) );


	h_ori_Wjetsfac025  = (TH1F*)f->Get(Form("H_Wjets_e%s_WBF_%s_%s_fac025",  flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()) ) ;
	h_ori_Wjetsfac025  ->Add((TH1F*)f->Get(Form("H_Wjets_e%s_WBF_%s_%s_fac025",  flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())) );
	
	h_ori_Wjetsrenorm025  = (TH1F*)f->Get(Form("H_Wjets_e%s_WBF_%s_%s_renorm025",  flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()) ) ;
	h_ori_Wjetsrenorm025  ->Add( (TH1F*)f->Get(Form("H_Wjets_e%s_WBF_%s_%s_renorm025",  flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()) ) );
	
	h_ori_Wjetsckkw15  = (TH1F*)f->Get(Form("H_Wjets_e%s_WBF_%s_%s_ckkw15",  flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()) ) ;
	h_ori_Wjetsckkw15  ->Add( (TH1F*)f->Get(Form("H_Wjets_e%s_WBF_%s_%s_ckkw15",  flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()) ) );
	...
	for (int i=0;i<nsyst;i++){
	  h_ori_WjetsS[i]=(TH1F*)f->Get(Form("H_Wjets_e%s_WBF_%s_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(), typeName[itype].Data(), systname[i].Data()));
	  h_ori_WjetsS[i]->Add((TH1F*)f->Get(Form("H_Wjets_m%s_WBF_%s_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data(),systname[i].Data())));

	  h_ori_WjetsEWKS[i]=(TH1F*)f->Get(Form("H_WjetsEWKSherpa_e%s_WBF_%s_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data(),systname[i].Data()));
	  h_ori_WjetsEWKS[i]->Add((TH1F*)f->Get(Form("H_WjetsEWKSherpa_m%s_WBF_%s_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data(),systname[i].Data())));
	  

	  h_ori_ZjetsS[i]=(TH1F*)f->Get(Form("H_Zjets_e%s_WBF_%s_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data(),systname[i].Data()));
	  h_ori_ZjetsS[i]->Add((TH1F*)f->Get(Form("H_Zjets_m%s_WBF_%s_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data(),systname[i].Data())));
	  

	  h_ori_dibosonS[i]=(TH1F*)f->Get(Form("H_WZZZWg_e%s_WBF_%s_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data(),systname[i].Data()));
	  h_ori_dibosonS[i]->Add((TH1F*)f->Get(Form("H_WZZZWg_m%s_WBF_%s_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data(),systname[i].Data())));
	  
	  
	  h_ori_singleTopS[i]=(TH1F*)f->Get(Form("H_SingleTop_e%s_WBF_%s_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data(),systname[i].Data()));
	  h_ori_singleTopS[i]->Add((TH1F*)f->Get(Form("H_SingleTop_m%s_WBF_%s_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data(),systname[i].Data())));
	  
	  
	  h_ori_ttbarS[i]=(TH1F*)f->Get(Form("H_Ttbar_e%s_WBF_%s_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data(),systname[i].Data()));
	  h_ori_ttbarS[i]->Add((TH1F*)f->Get(Form("H_Ttbar_m%s_WBF_%s_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data(),systname[i].Data())));

	  h_ori_sigSMS[i]=(TH1F*)f->Get(Form("H_VBS_WV_0_0_e%s_WBF_%s_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data(),systname[i].Data()));
	  h_ori_sigSMS[i]->Add((TH1F*)f->Get(Form("H_VBS_WV_0_0_m%s_WBF_%s_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data(),systname[i].Data())));
	  h_ori_sigSMS[i]->Add((TH1F*)f->Get(Form("H_VBS_ZV_0_0_e%s_WBF_%s_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data(),systname[i].Data())));
	  h_ori_sigSMS[i]->Add((TH1F*)f->Get(Form("H_VBS_ZV_0_0_m%s_WBF_%s_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data(),systname[i].Data())));
