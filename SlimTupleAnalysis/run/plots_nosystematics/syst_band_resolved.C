...
void syst_band_resolved(){ 
  ...
  TH1F *h_data,*h_Wjets,*h_WjetsScaled,*h_WjetsEWK, *h_Zjets,*h_diboson,*h_singleTop, *h_ttbar, *h_qcd, *h_MC, *h_MCN;//h_MC and h_MCN are sum of nominal bkg samples with and without QCD respectively.TH1F *h_data
  TH1F *h_sigSM;
  ...
  //TFile *f=TFile::Open("~azaman/Analysis5/SlimTupleAnalysis/run/HWWLVQQ.caf4.2.lv8_smw_wp20_NEW_MjjTag200_10_April30/lvqqCombQCD_plots.root");
  ...
  for (int isyst=0;isyst<nsyst;isyst++)
    { 
      ...
      //fsyst[isyst]=TFile::Open(Form("~azaman/Analysis5/SlimTupleAnalysis/run/HWWLVQQ.caf4.2.lv8_smw_wp20_NEW_MjjTag200_10_April30/hwwlvqq.%s.root",systname[isyst].Data()));
    }
  ...
  //TFile* fsyst_ttbar =TFile::Open("~azaman/Analysis5/SlimTupleAnalysis/run/HWWLVQQ.caf4.2.lv8_smw_wp20_NEW_nocutAwv/hwwlvqq.Nominal.caf4.2.lv8_smw_nocutAwv_ttbar.root");
  ...
  //TFile* fsyst_ttbar =TFile::Open("~azaman/Analysis5/SlimTupleAnalysis/run/HWWLVQQ.caf4.2.lv8_smw_wp20_NEW_MjjTag200_10_April30/hwwlvqq.ttbar.root");
  ...
  //TFile* fsyst_wjets =TFile::Open("~azaman/Analysis5/SlimTupleAnalysis/run/HWWLVQQ.caf4.2.lv8_smw_wp20_NEW_nocutAwv/hwwlvqq.WjetsTruthSyst.root");
  ...
  //TFile* fsyst_wjets =TFile::Open("~azaman/Analysis5/SlimTupleAnalysis/run/HWWLVQQ.caf4.2.lv8_smw_wp20_NEW_MjjTag200_10_April30/hwwlvqq.WjetsTruthSyst.root");
  ...
  for (int icut=0;icut<nCut;++icut){
	...
	h_data=(TH1F*)f->Get(Form("H_Data_e%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data()));
	h_data->Add((TH1F*)f->Get(Form("H_Data_m%s_WBF_%s_%s", flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())));
	...
	h_WjetsScaled=(TH1F*)f->Get(Form("H_WjetsScaled_e%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data()));
	h_WjetsScaled->Add((TH1F*)f->Get(Form("H_WjetsScaled_m%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data())));
	...
	// /*
	////ttbar systematics
	h_ttbarMCatNLO=(TH1F*)fsyst_ttbar->Get(Form("H_TtbarMCatNLO_e%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()));
	h_ttbarMCatNLO->Add ( (TH1F*)fsyst_ttbar->Get(Form("H_TtbarMCatNLO_m%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())));
	
	h_ttbarPowHer=(TH1F*)fsyst_ttbar->Get(Form("H_TtbarPowHer_e%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()));
	h_ttbarPowHer->Add ( (TH1F*)fsyst_ttbar->Get(Form("H_TtbarPowHer_m%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())));
	
	h_ttbarAcerMCUp=(TH1F*)fsyst_ttbar->Get(Form("H_TtbarAcerMCUp_e%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()));
	h_ttbarAcerMCUp->Add ( (TH1F*)fsyst_ttbar->Get(Form("H_TtbarAcerMCUp_m%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())));
	
	h_ttbarAcerMCDown=(TH1F*)fsyst_ttbar->Get(Form("H_TtbarAcerMCDown_e%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()));
	h_ttbarAcerMCDown->Add ( (TH1F*)fsyst_ttbar->Get(Form("H_TtbarAcerMCDown_m%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())));
	// */

	//	 /*
	////W+jets systematics (only electron is available) so use mp->ep, mm->em
	h_Wjetsnom  = (TH1F*)fsyst_wjets->Get(Form("H_Wjets_e%s_WBF_%s_%s",  flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()) ) ;
	h_Wjetsnom  ->Add( (TH1F*)fsyst_wjets->Get(Form("H_Wjets_e%s_WBF_%s_%s",  flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()) ) );
	
	h_Wjetsfac  = (TH1F*)fsyst_wjets->Get(Form("H_TruthWjetsfac4_e%s_WBF_%s_%s",  flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()) ) ;
	h_Wjetsfac  ->Add((TH1F*)fsyst_wjets->Get(Form("H_TruthWjetsfac4_e%s_WBF_%s_%s",  flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())) );
	
	h_Wjetsrenorm  = (TH1F*)fsyst_wjets->Get(Form("H_TruthWjetsrenorm4_e%s_WBF_%s_%s",  flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()) ) ;
	h_Wjetsrenorm  ->Add( (TH1F*)fsyst_wjets->Get(Form("H_TruthWjetsrenorm4_e%s_WBF_%s_%s",  flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()) ) );
	
	h_Wjetsckkw  = (TH1F*)fsyst_wjets->Get(Form("H_TruthWjetsckkw30_e%s_WBF_%s_%s",  flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()) ) ;
	h_Wjetsckkw  ->Add( (TH1F*)fsyst_wjets->Get(Form("H_TruthWjetsckkw30_e%s_WBF_%s_%s",  flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()) ) );

	h_Wjetsfac025  = (TH1F*)fsyst_wjets->Get(Form("H_TruthWjetsfac025_e%s_WBF_%s_%s",  flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()) ) ;
	h_Wjetsfac025  ->Add((TH1F*)fsyst_wjets->Get(Form("H_TruthWjetsfac025_e%s_WBF_%s_%s",  flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())) );
	
	h_Wjetsrenorm025  = (TH1F*)fsyst_wjets->Get(Form("H_TruthWjetsrenorm025_e%s_WBF_%s_%s",  flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()) ) ;
	h_Wjetsrenorm025  ->Add( (TH1F*)fsyst_wjets->Get(Form("H_TruthWjetsrenorm025_e%s_WBF_%s_%s",  flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()) ) );
	
	h_Wjetsckkw15  = (TH1F*)fsyst_wjets->Get(Form("H_TruthWjetsckkw15_e%s_WBF_%s_%s",  flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()) ) ;
	h_Wjetsckkw15  ->Add( (TH1F*)fsyst_wjets->Get(Form("H_TruthWjetsckkw15_e%s_WBF_%s_%s",  flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()) ) );
	...
	for (int i=0;i<nsyst;i++){
	  h_WjetsS[i]=(TH1F*)fsyst[i]->Get(Form("H_Wjets_e%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data()));
	  h_WjetsS[i]->Add((TH1F*)fsyst[i]->Get(Form("H_Wjets_m%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data())));

	  h_WjetsEWKS[i]=(TH1F*)fsyst[i]->Get(Form("H_WjetsEWKSherpa_e%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data()));
	  h_WjetsEWKS[i]->Add((TH1F*)fsyst[i]->Get(Form("H_WjetsEWKSherpa_m%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data())));
	  

	  h_ZjetsS[i]=(TH1F*)fsyst[i]->Get(Form("H_Zjets_e%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data()));
	  h_ZjetsS[i]->Add((TH1F*)fsyst[i]->Get(Form("H_Zjets_m%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data())));
	  

	  h_dibosonS[i]=(TH1F*)fsyst[i]->Get(Form("H_WZZZWg_e%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data()));
	  h_dibosonS[i]->Add((TH1F*)fsyst[i]->Get(Form("H_WZZZWg_m%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data())));
	  
	  
	  h_singleTopS[i]=(TH1F*)fsyst[i]->Get(Form("H_SingleTop_e%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data()));
	  h_singleTopS[i]->Add((TH1F*)fsyst[i]->Get(Form("H_SingleTop_m%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data())));
	  
	  
	  h_ttbarS[i]=(TH1F*)fsyst[i]->Get(Form("H_Ttbar_e%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data()));
	  h_ttbarS[i]->Add((TH1F*)fsyst[i]->Get(Form("H_Ttbar_m%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data())));

	  h_sigSMS[i]=(TH1F*)fsyst[i]->Get(Form("H_VBS_WV_0_0_e%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data()));
	  h_sigSMS[i]->Add((TH1F*)fsyst[i]->Get(Form("H_VBS_WV_0_0_m%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data())));
	  h_sigSMS[i]->Add((TH1F*)fsyst[i]->Get(Form("H_VBS_ZV_0_0_e%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data())));
	  h_sigSMS[i]->Add((TH1F*)fsyst[i]->Get(Form("H_VBS_ZV_0_0_m%s_WBF_%s_%s", flavorName[iFlavor].Data(),  cutName[icut].Data(),typeName[itype].Data())));
	...
	for (int ibin =1;ibin<=nbins;ibin++){
	  ...
	  if(h_MCN->GetBinContent(ibin) !=0.){
	    ...
	    fracErrLimMC += pow( h_MCN->GetBinError(ibin)/h_MCN->GetBinContent(ibin) , 2); //bin-by-bin uncertainty due to limited statistics in MC (no QCD)
	    ...
	    cout<<"h_Wjets->GetBinContent(ibin) * 0.82= "<<h_Wjets->GetBinContent(ibin) * 0.82 <<endl;
	    //cout<<"h_WjetsEWK->GetBinContent(ibin)= "<<h_WjetsEWK->GetBinContent(ibin)<<endl;
	    ...
	    //fracErrWjetsMod+=pow((h_Wjetsnom->GetBinContent(ibin)-h_Wjetsfac025->GetBinContent(ibin))*h_Wjets->GetBinContent(ibin)/(h_Wjetsnom->GetBinContent(ibin)*h_MCN->GetBinContent(ibin)),2); //W+jets scale uncertainty
	    //fracErrWjetsMod+=pow((h_Wjetsnom->GetBinContent(ibin)-h_Wjetsrenorm025->GetBinContent(ibin))*h_Wjets->GetBinContent(ibin)/(h_Wjetsnom->GetBinContent(ibin)*h_MCN->GetBinContent(ibin)),2);
	    //fracErrWjetsMod+=pow((h_Wjetsnom->GetBinContent(ibin)-h_Wjetsckkw15->GetBinContent(ibin))*h_Wjets->GetBinContent(ibin)/(h_Wjetsnom->GetBinContent(ibin)*h_MCN->GetBinContent(ibin)),2);
