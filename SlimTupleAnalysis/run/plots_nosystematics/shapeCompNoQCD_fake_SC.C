{
  ...
  bool pdfforNote = 1;
  if (!pdfforNote)c2->Print("plots_shape_noQCD.pdf[" );
  ...
  //const int nFlav=1;TString flavName[nFlav]={"ep"};
  ...
  for (int itype=0;itype<nType;++itype){
	...
	logy = true;
       ...
       h_data=(TH1F*)f->Get(Form("H_Data_%s_WBF_%s_%s",flavName[iflav].Data(), cutName[icut].Data(),typeName[itype].Data()));
       h_Wjets=(TH1F*)f->Get(Form("H_Wjets_%s_WBF_%s_%s",flavName[iflav].Data(), cutName[icut].Data(),typeName[itype].Data()));
       
       h_Zjets=(TH1F*)f->Get(Form("H_Zjets_%s_WBF_%s_%s",flavName[iflav].Data(), cutName[icut].Data(),typeName[itype].Data()));
       
       h_diboson=(TH1F*)f->Get(Form("H_WZZZWg_%s_WBF_%s_%s",flavName[iflav].Data(), cutName[icut].Data(),typeName[itype].Data()));
       
       h_singleTop=(TH1F*)f->Get(Form("H_SingleTop_%s_WBF_%s_%s",flavName[iflav].Data(), cutName[icut].Data(),typeName[itype].Data()));
       
       h_ttbar=(TH1F*)f->Get(Form("H_Ttbar_%s_WBF_%s_%s",flavName[iflav].Data(), cutName[icut].Data(),typeName[itype].Data()));
       
     
        

       //h_WV_0_0=(TH1F*)f1->Get(Form("H_VBS_WV_0_0_%s_WBF_%s_%s",flavName[iflav].Data(), cutName[icut].Data(),typeName[itype].Data()));
       //h_ZV_0_0=(TH1F*)f1->Get(Form("H_VBS_ZV_0_0_%s_WBF_%s_%s",flavName[iflav].Data(), cutName[icut].Data(),typeName[itype].Data()));
       	

       h_data2=(TH1F*)f1->Get(Form("H_Data_%s_WBF_%s_%s",flavName[iflav].Data(), cutName[icut].Data(),typeName[itype].Data()));
       
       h_Wjets2=(TH1F*)f1->Get(Form("H_Wjets_%s_WBF_%s_%s",flavName[iflav].Data(), cutName[icut].Data(),typeName[itype].Data()));
       
       h_Zjets2=(TH1F*)f1->Get(Form("H_Zjets_%s_WBF_%s_%s",flavName[iflav].Data(), cutName[icut].Data(),typeName[itype].Data()));
       
       h_diboson2=(TH1F*)f1->Get(Form("H_WZZZWg_%s_WBF_%s_%s",flavName[iflav].Data(), cutName[icut].Data(),typeName[itype].Data()));
       
       h_singleTop2=(TH1F*)f1->Get(Form("H_SingleTop_%s_WBF_%s_%s",flavName[iflav].Data(), cutName[icut].Data(),typeName[itype].Data()));
       
       h_ttbar2=(TH1F*)f1->Get(Form("H_Ttbar_%s_WBF_%s_%s",flavName[iflav].Data(), cutName[icut].Data(),typeName[itype].Data()));
	...
	//h_data->GetYaxis()->SetRangeUser(1,maxi*500);
      ...
      l.DrawLatex(0.20 , 0.76,"#int Ldt = 20.2 fb^{-1}");
      TString latexFlav("");
      if (flavName[iflav] == "ep") { latexFlav = "e^{+}";}
      else if (flavName[iflav] == "em") { latexFlav = "e^{-}";}
      else if (flavName[iflav] == "mp") {  latexFlav = "#mu^{+}";}
      else if (flavName[iflav] == "mm") {  latexFlav = "#mu^{-}";}
      l.DrawLatex(0.20 , 0.68,Form("#bf{ W#rightarrow %s#nu , %s}", latexFlav.Data(),cutName[icut].Data() ) );
      ...
      if (!pdfforNote) {
	c2->Print("plots_shape_noQCD.pdf",Form("Title:%s_%s_%s",flavName[iflav].Data(),cutName[icut].Data(),typeName[itype].Data()));
      }else{
	c2->Print(Form("PDF_syst_band/shapeComp_fake_%s_%s_%s.pdf",flavName[iflav].Data(), cutName[icut].Data(), typeName[itype].Data() ));
      }
