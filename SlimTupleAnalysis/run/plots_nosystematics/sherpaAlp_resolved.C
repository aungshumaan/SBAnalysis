...
#include "stackStyle.h"
  ...
  const int nCharge =2; TString chargeName[nCharge] = { "p","m"};
  ...
  for (int iRegion=0;iRegion<nRegion;iRegion++){	  
    for (int iHist=0;iHist<nHist;iHist++){
	  ...
	  TH1F* h1_ori=(TH1F*)f1->Get(Form("H_Wjets_e%s_WBF_%s_%s", chargeName[iCharge].Data(), regionName[iRegion].Data(), histName[iHist].Data()) );
	  h1_ori->Add( (TH1F*)f1->Get(Form("H_Wjets_m%s_WBF_%s_%s", chargeName[iCharge].Data(), regionName[iRegion].Data(), histName[iHist].Data()) ) );
	  TH1F* h2_ori=(TH1F*)f2->Get(Form("H_WjetsAlp_e%s_WBF_%s_%s", chargeName[iCharge].Data(), regionName[iRegion].Data(), histName[iHist].Data()) );
	  h2_ori->Add( (TH1F*)f2->Get(Form("H_WjetsAlp_m%s_WBF_%s_%s", chargeName[iCharge].Data(), regionName[iRegion].Data(), histName[iHist].Data()) ) );
	  
	  
	  TH1F* hnom_ori=(TH1F*)f3->Get(Form("H_Wjets_e%s_WBF_%s_%s", chargeName[iCharge].Data(), regionName[iRegion].Data(), histName[iHist].Data()) );
	  hnom_ori   ->Add( (TH1F*)f3->Get(Form("H_Wjets_e%s_WBF_%s_%s", chargeName[iCharge].Data(), regionName[iRegion].Data(), histName[iHist].Data()) ) );
	  
	  TH1F* hfac_ori=(TH1F*)f3->Get(Form("H_TruthWjetsfac4_e%s_WBF_%s_%s", chargeName[iCharge].Data(), regionName[iRegion].Data(), histName[iHist].Data()) );
	  hfac_ori   ->Add( (TH1F*)f3->Get(Form("H_TruthWjetsfac4_e%s_WBF_%s_%s", chargeName[iCharge].Data(), regionName[iRegion].Data(), histName[iHist].Data()) ) );
	  
	  TH1F* hrenorm_ori=(TH1F*)f3->Get(Form("H_TruthWjetsrenorm4_e%s_WBF_%s_%s", chargeName[iCharge].Data(), regionName[iRegion].Data(), histName[iHist].Data()) );
	  hrenorm_ori->Add( (TH1F*)f3->Get(Form("H_TruthWjetsrenorm4_e%s_WBF_%s_%s", chargeName[iCharge].Data(), regionName[iRegion].Data(), histName[iHist].Data()) ) );
	  
	  TH1F* hckkw_ori=(TH1F*)f3->Get(Form("H_TruthWjetsckkw30_e%s_WBF_%s_%s", chargeName[iCharge].Data(), regionName[iRegion].Data(), histName[iHist].Data()) );
	  hckkw_ori->Add( (TH1F*)f3->Get(Form("H_TruthWjetsckkw30_e%s_WBF_%s_%s", chargeName[iCharge].Data(), regionName[iRegion].Data(), histName[iHist].Data()) ) );
	...
	TString latexCharge("");
	if (chargeName[iCharge] == "p") { latexCharge = "l^{+}";}
	else if (chargeName[iCharge] == "m") { latexCharge = "l^{-}";}
	//l.DrawLatex(0.15 , 0.84,"ATLAS #bf{Internal}");
	l.DrawLatex(0.15 , 0.84,"ATLAS #bf{Preliminary}");
	l.DrawLatex(0.15 , 0.76,Form("#int Ldt = 20.2 fb^{-1}, #bf{ W#rightarrow %s#nu , %s}", latexCharge.Data(),regionName[iRegion].Data()));
	...
	ratioHist->SetTitle("ratio");
	  ...
	  //c1->Print("plots_sherpaAlp_tmp.pdf",Form("Title:%s_%s_%s", chargeName[iCharge].Data(), regionName[iRegion].Data(), histName[iHist].Data()));
	  c1->Print(Form("PDF_syst_band/sherpaAlp_%s_%s_%s_ptwlep0.pdf",chargeName[iCharge].Data(), regionName[iRegion].Data(), histName[iHist].Data() ) );	  
