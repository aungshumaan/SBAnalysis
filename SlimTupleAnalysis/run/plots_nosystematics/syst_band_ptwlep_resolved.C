...
void syst_band_ptwlep_resolved(){ 
  ...
  for (int icut=0;icut<nCut;++icut){
	...
	h_data_ori=(TH1F*)f->Get(Form("H_Data_e%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()));
	h_data_ori->Add ((TH1F*)f->Get(Form("H_Data_m%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())));

	h_Wjets_ori=(TH1F*)f->Get(Form("H_Wjets_e%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()));
	h_Wjets_ori->Add ((TH1F*)f->Get(Form("H_Wjets_m%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())));

	h_WjetsEWK_ori=(TH1F*)f->Get(Form("H_WjetsEWKSherpa_e%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()));
	h_WjetsEWK_ori->Add ((TH1F*)f->Get(Form("H_WjetsEWKSherpa_m%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())));


	h_WjetsScaled_ori=(TH1F*)f->Get(Form("H_WjetsScaled_e%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()));
	h_WjetsScaled_ori->Add ((TH1F*)f->Get(Form("H_WjetsScaled_m%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())));

      
	h_Zjets_ori=(TH1F*)f->Get(Form("H_Zjets_e%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()));
	h_Zjets_ori->Add ((TH1F*)f->Get(Form("H_Zjets_m%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())));
	
	h_diboson_ori=(TH1F*)f->Get(Form("H_WZZZWg_e%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()));
	h_diboson_ori->Add ((TH1F*)f->Get(Form("H_WZZZWg_m%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())));

	h_singleTop_ori=(TH1F*)f->Get(Form("H_SingleTop_e%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()));
	h_singleTop_ori->Add ((TH1F*)f->Get(Form("H_SingleTop_m%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())));

	h_ttbar_ori=(TH1F*)f->Get(Form("H_Ttbar_e%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()));
	h_ttbar_ori->Add ((TH1F*)f->Get(Form("H_Ttbar_m%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())));

	h_qcd_ori=(TH1F*)f->Get(Form("H_QCD_e%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()));
	h_qcd_ori->Add ((TH1F*)f->Get(Form("H_QCD_m%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())));
	...
	*/
	...
	/// mTWV HARD CODING VARIABLE BINS
	Double_t bins_mtwv[6]= {0., 300., 500., 600., 700., 1500.};
	//Double_t bins_fat[5]= {300., 600., 700., 800.,  1500.};  
	
	h_data = (TH1F*) h_data_ori-> Rebin(5, "h_data", bins_mtwv);
	h_Wjets = (TH1F*)  h_Wjets_ori-> Rebin(5, "h_Wjets", bins_mtwv);
	h_WjetsEWK = (TH1F*)  h_WjetsEWK_ori-> Rebin(5, "h_WjetsEWK", bins_mtwv);
	h_WjetsScaled = (TH1F*)  h_WjetsScaled_ori-> Rebin(5, "h_WjetsScaled", bins_mtwv);
	h_Zjets = (TH1F*)  h_Zjets_ori-> Rebin(5, "h_Zjets", bins_mtwv);
	h_diboson = (TH1F*)  h_diboson_ori-> Rebin(5, "h_diboson", bins_mtwv);
	h_singleTop = (TH1F*)  h_singleTop_ori-> Rebin(5, "h_singleTop", bins_mtwv);
	h_ttbar = (TH1F*)  h_ttbar_ori-> Rebin(5, "h_ttbar", bins_mtwv);
	h_qcd = (TH1F*)  h_qcd_ori-> Rebin(5, "h_qcd", bins_mtwv);
	...
	*/
	...
	for (int i=0;i<nsyst;i++){
	  h_WjetsS_ori[i]=(TH1F*)fsyst[i]->Get(Form("H_Wjets_e%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()));
	  h_WjetsS_ori[i]->Add((TH1F*)fsyst[i]->Get(Form("H_Wjets_m%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())));
	  
	  h_WjetsEWKS_ori[i]=(TH1F*)fsyst[i]->Get(Form("H_WjetsEWKSherpa_e%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()));
	  h_WjetsEWKS_ori[i]->Add((TH1F*)fsyst[i]->Get(Form("H_WjetsEWKSherpa_m%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())));
	  

	  h_ZjetsS_ori[i]=(TH1F*)fsyst[i]->Get(Form("H_Zjets_e%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()));
	  h_ZjetsS_ori[i]->Add((TH1F*)fsyst[i]->Get(Form("H_Zjets_m%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())));
 
	  h_dibosonS_ori[i]=(TH1F*)fsyst[i]->Get(Form("H_WZZZWg_e%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()));
	  h_dibosonS_ori[i]->Add((TH1F*)fsyst[i]->Get(Form("H_WZZZWg_m%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())));
	  
	  h_singleTopS_ori[i]=(TH1F*)fsyst[i]->Get(Form("H_SingleTop_e%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()));
	  h_singleTopS_ori[i]->Add((TH1F*)fsyst[i]->Get(Form("H_SingleTop_m%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())));

	  h_ttbarS_ori[i]=(TH1F*)fsyst[i]->Get(Form("H_Ttbar_e%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data()));
	  h_ttbarS_ori[i]->Add((TH1F*)fsyst[i]->Get(Form("H_Ttbar_m%s_WBF_%s_%s",flavorName[iFlavor].Data(), cutName[icut].Data(),typeName[itype].Data())));
	  ...
	  */
	  ...
	  h_WjetsS[i] = (TH1F*)  h_WjetsS_ori[i]-> Rebin(5, "h_Wjets", bins_mtwv);
	  h_WjetsEWKS[i] = (TH1F*)  h_WjetsEWKS_ori[i]-> Rebin(5, "h_WjetsEWK", bins_mtwv);
	  h_ZjetsS[i] = (TH1F*)  h_ZjetsS_ori[i]-> Rebin(5, "h_Zjets", bins_mtwv);
	  h_dibosonS[i] = (TH1F*)  h_dibosonS_ori[i]-> Rebin(5, "h_diboson", bins_mtwv);
	  h_singleTopS[i] = (TH1F*)  h_singleTopS_ori[i]-> Rebin(5, "h_singleTop", bins_mtwv);
	  h_ttbarS[i] = (TH1F*)  h_ttbarS_ori[i]-> Rebin(5, "h_ttbar", bins_mtwv);
